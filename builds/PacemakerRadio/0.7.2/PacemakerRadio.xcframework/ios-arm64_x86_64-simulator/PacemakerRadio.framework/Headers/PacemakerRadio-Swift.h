...
/// \param waveformPointsPerTrack The number of points representing a waveform for a track, maximum of 1024
///
...
/// \param identifier The identifier of a track
///
/// \param applyEnterTransition true if you want the transition to the left of the track to be applied to the waveform data, false otherwise
///
/// \param applyExitTransition true if you want the transition to the right of the track to be applied to the waveform data, false otherwise
///
- (NSArray<NSArray<NSNumber *> *> * _Nullable)waveformDataForTrackWithIdentifier:(NSString * _Nonnull)identifier applyEnterTransition:(BOOL)applyEnterTransition applyExitTransition:(BOOL)applyExitTransition SWIFT_WARN_UNUSED_RESULT;
...
/// \param identifier The identifier of a track
///
- (NSArray<NSArray<NSNumber *> *> * _Nullable)placeholderWaveformDataForTrackWithIdentifier:(NSString * _Nonnull)identifier SWIFT_WARN_UNUSED_RESULT;
...
///   </li>
/// </ul>
- (AutomixSDKStatus * _Nullable)automixStatus SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// AutomixSDKArtistModel models an artist.
...
/// AutomixSDKLogLevel is an enum of all the AutomixIQ available log levels
...
/// AutomixSDKPlaybackEventType is an enum of all the available playback events
...
typedef SWIFT_ENUM(NSInteger, AutomixSDKPlaybackMode, open) {
  AutomixSDKPlaybackModeAutomix = 0,
  AutomixSDKPlaybackModeLiveCreation = 1,
  AutomixSDKPlaybackModeLiveConsumption = 2,
};
...
/// AutomixSDKStatusObserverDelegate protocol defines the methods to be implemented with observing the status of AutomixIQ to reflect it on a UI.
...
/// \param variables a list of AutomixSDKStatusVariable that changed since last time this method was called, or since AutomixIQ was initialised.
///
...
/// Called when waveform data for a track is available, you can request the data using AutomixIQ’s method waveformDataForTrack:applyTransitions:
...
typedef SWIFT_ENUM(NSInteger, AutomixSDKStatusVariable, open) {
  ...
  AutomixSDKStatusVariablePlayingTrackIndex = 3,
  AutomixSDKStatusVariablePlayingTrackCurrentTime = 4,
  AutomixSDKStatusVariablePlayingTrackTotalTime = 5,
  AutomixSDKStatusVariablePlayingTrackStreamingProgress = 6,
  AutomixSDKStatusVariableReplayOn = 7,
  AutomixSDKStatusVariableCanSkipToPrevious = 8,
  AutomixSDKStatusVariableCanBack = 9,
  AutomixSDKStatusVariableCanSkipToNext = 10,
  AutomixSDKStatusVariableCanPlayPause = 11,
  AutomixSDKStatusVariableCanSeek = 12,
  AutomixSDKStatusVariableCanReorderTracks = 13,
  AutomixSDKStatusVariableReadyToPlay = 14,
  AutomixSDKStatusVariableCanMixNow = 15,
  AutomixSDKStatusVariablePlaylist = 16,
  AutomixSDKStatusVariableMuted = 17,
  AutomixSDKStatusVariablePlaySpeed = 18,
  AutomixSDKStatusVariableNormalisedVolume = 19,
  AutomixSDKStatusVariablePreferredTransitionDurationSeconds = 20,
  AutomixSDKStatusVariableRequestedLoopTrackIdentifier = 21,
  AutomixSDKStatusVariableRequestedPauseTrackIdentifier = 22,
  AutomixSDKStatusVariableVinylStartStop = 23,
  AutomixSDKStatusVariableNextTransitionDuration = 24,
  AutomixSDKStatusVariableTransitionStartTimeSeconds = 25,
  AutomixSDKStatusVariableFailedTrackLoadIdentifiers = 26,
  AutomixSDKStatusVariableCanOnOff = 27,
  AutomixSDKStatusVariablePlayingTrackOriginalSessionId = 28,
  AutomixSDKStatusVariableExplicitLyricsFiltering = 29,
  AutomixSDKStatusVariableMixId = 30,
  AutomixSDKStatusVariablePlaybackMode = 31,
};

@class NSData;

/// AutomixSDKStreamingDelegate protocol defines the methods to be implemented with providing AutomixIQ the information it requires to play content.
...
/// Starts a Radio session in creation mode, with an empty playlist
/// \param completion Code to be executed upon completing the asynchronous request.
///
/// \a completion parameters:
/// <ul>
...
///
///
- (void)startRadioSessionWithCompletion:(void (^ _Nullable)(NSError * _Nullable, UIViewController * _Nullable))completion;
...
/// In order top start a consumption session, call joinLiveMixtape()
///
/// returns:
...
///
///
- (void)joinLiveMixtapeWithIdentifier:(NSString * _Nonnull)identifier completion:(void (^ _Nonnull)(NSError * _Nullable, UIViewController * _Nullable))completion;
/// Returns the initialised status of the Automix SDK.
/// <ul>
///   <li>
///     returns true if initialised, false otherwise.
...
/// Called by AutomixSDK when the Radio UI is dismissed
- (void)didDismissRadioUI;
@end
...
/// TunedMusicCacheDelegate protocol defines the methods to be implemented with storing and providing cached track data
