...
SWIFT_CLASS("_TtC14PacemakerRadio16AutomixSDKConfig")
@interface AutomixSDKConfig : NSObject
...
typedef SWIFT_ENUM(NSInteger, AutomixSDKErrorCode, open) {
  ...
  AutomixSDKErrorCodeUnable_to_load_mix = 1031,
  AutomixSDKErrorCodeUnimplemented = 1032,
  AutomixSDKErrorCodeCancelled = 1033,
  AutomixSDKErrorCodeOnAlreadyTurningOn = 1034,
  AutomixSDKErrorCodeOnWhileTurningOff = 1035,
  AutomixSDKErrorCodeOffAlreadyTurningOff = 1036,
  AutomixSDKErrorCodeOffWhileTurningOn = 1037,
  AutomixSDKErrorCodeCannotCreateChannelLayout = 1038,
  AutomixSDKErrorCodeCannotCreateInputBuffer = 1039,
  AutomixSDKErrorCodeCannotSetupAVAudioSession = 1040,
  AutomixSDKErrorCodeCannotStartAudioEngine = 1041,
  AutomixSDKErrorCodeCannotRestoreAudioSession = 1042,
  AutomixSDKErrorCodeFailedToStop = 1043,
  AutomixSDKErrorCodeCannotLoadExplicitLyricsTrack = 1044,
};
...
/// \param config The RadioSDK configuration.
///
...
///
///
+ (void)initialiseWithConfig:(RadioSDKConfig * _Nonnull)config tunedDelegate:(id <TunedRestDelegate> _Nonnull)tunedDelegate statusDelegate:(id <AutomixSDKStatusObserverDelegate> _Nonnull)statusDelegate radioUIDelegate:(id <RadioUIDelegate> _Nonnull)radioUIDelegate musicCacheDelegate:(id <TunedMusicCacheDelegate> _Nullable)musicCacheDelegate completion:(void (^ _Nullable)(NSError * _Nullable))completion;
/// Terminates / deinitialises PacemakerRadio. Call this on applicationWillTerminate, or whenever you no longer need it.
- (void)terminate;
/// Returns the singleton instance.
///
/// returns:
...
@class UIColor;
@class RadioSDKFeatureSetConfig;
@class RadioSDKUIConfig;

SWIFT_CLASS("_TtC14PacemakerRadio14RadioSDKConfig")
@interface RadioSDKConfig : AutomixSDKConfig
...
- (nonnull instancetype)initWithApiKey:(NSString * _Nonnull)apiKey country:(NSString * _Nonnull)country storeId:(NSString * _Nonnull)storeId applicationId:(NSString * _Nonnull)applicationId featureSetConfig:(RadioSDKFeatureSetConfig * _Nonnull)featureSetConfig uiConfig:(RadioSDKUIConfig * _Nonnull)uiConfig OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, strong) RadioSDKFeatureSetConfig * _Nonnull featureSetConfig;
@property (nonatomic, strong) RadioSDKUIConfig * _Nonnull uiConfig;
- (nonnull instancetype)initWithApiKey:(NSString * _Nonnull)apiKey country:(NSString * _Nonnull)country storeId:(NSString * _Nonnull)storeId applicationId:(NSString * _Nonnull)applicationId SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS("_TtC14PacemakerRadio24RadioSDKFeatureSetConfig")
@interface RadioSDKFeatureSetConfig : NSObject
- (nonnull instancetype)initWithAllowFX:(BOOL)allowFX allowAudioEffects:(BOOL)allowAudioEffects allowBackgrounds:(BOOL)allowBackgrounds allowCommenting:(BOOL)allowCommenting allowVoiceOver:(BOOL)allowVoiceOver allowSongSuggestions:(BOOL)allowSongSuggestions allowInvites:(BOOL)allowInvites allowPublicBroadcasts:(BOOL)allowPublicBroadcasts allowStudio:(BOOL)allowStudio deeplinkToUser:(NSString * _Nonnull)deeplinkToUser OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC14PacemakerRadio16RadioSDKUIConfig")
@interface RadioSDKUIConfig : NSObject
...
///
///
- (void)presentTracklistWithCompletion:(void (^ _Nonnull)(NSArray<AutomixSDKTrackModel *> * _Nullable, NSString * _Nullable))completion;
