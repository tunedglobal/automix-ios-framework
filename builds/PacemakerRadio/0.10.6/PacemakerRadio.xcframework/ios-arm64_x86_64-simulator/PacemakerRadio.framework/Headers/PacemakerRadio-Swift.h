...
///
- (AutomixSDKWaveformModel * _Nullable)waveformDataForTrackWithIdentifier:(NSString * _Nonnull)identifier applyTransitions:(BOOL)applyTransitions SWIFT_WARN_UNUSED_RESULT;
/// Gets the waveform data for a track.
/// <ul>
///   <li>
///     returns the waveform data
...
///
- (AutomixSDKWaveformModel * _Nullable)waveformDataForTrackWithIdentifier:(NSString * _Nonnull)identifier applyEnterTransition:(BOOL)applyEnterTransition applyExitTransition:(BOOL)applyExitTransition SWIFT_WARN_UNUSED_RESULT;
...
/// \param identifier The identifier of a track
///
- (AutomixSDKWaveformModel * _Nullable)placeholderWaveformDataForTrackWithIdentifier:(NSString * _Nonnull)identifier SWIFT_WARN_UNUSED_RESULT;
...
/// The moment in the mixtape that was playing when the comment was made
...
typedef SWIFT_ENUM(NSInteger, AutomixSDKErrorCode, open) {
  ...
  AutomixSDKErrorCodeSdkNotInitialisedVersionNoLongerSupported = 1008,
  AutomixSDKErrorCodeSdkNotOn = 1009,
  AutomixSDKErrorCodeSdkAlreadyOn = 1010,
  AutomixSDKErrorCodeLoadTracksEmptyPlaylist = 1011,
  AutomixSDKErrorCodeLoadTracksOutOfBounds = 1012,
  AutomixSDKErrorCodeAddTrackPlaylistDoesNotExist = 1013,
  AutomixSDKErrorCodeAddTrackOutOfBounds = 1014,
  AutomixSDKErrorCodeAddTrackNoMetadata = 1015,
  AutomixSDKErrorCodeAddTrackInternalError = 1016,
  AutomixSDKErrorCodeRemoveTrackOutOfBounds = 1017,
  AutomixSDKErrorCodePlayAlreadyPlaying = 1018,
  AutomixSDKErrorCodePauseAlreadyPaused = 1019,
  AutomixSDKErrorCodeNextNoTrackAvailable = 1020,
  AutomixSDKErrorCodePreviousNoTrackAvailable = 1021,
  AutomixSDKErrorCodeBackNoTrackAvailable = 1022,
  AutomixSDKErrorCodeSeekNoTrackAvailable = 1023,
  AutomixSDKErrorCodeSeekNoCurrentTrack = 1024,
  AutomixSDKErrorCodeReorderMissingTrack = 1025,
  AutomixSDKErrorCodePlayToEndMissingTrack = 1026,
  AutomixSDKErrorCodePlayToEndMixEnd = 1027,
  AutomixSDKErrorCodeMoveTrackOutOfBounds = 1028,
  AutomixSDKErrorCodeStartLoopingNoLoopingTrack = 1029,
  AutomixSDKErrorCodeStopLoopingNoLoopingTrack = 1030,
  AutomixSDKErrorCodeUnimplemented = 1031,
  AutomixSDKErrorCodeCancelled = 1032,
  AutomixSDKErrorCodeOnAlreadyTurningOn = 1033,
  AutomixSDKErrorCodeOnWhileTurningOff = 1034,
  AutomixSDKErrorCodeOffAlreadyTurningOff = 1035,
  AutomixSDKErrorCodeOffWhileTurningOn = 1036,
  AutomixSDKErrorCodeCannotCreateChannelLayout = 1037,
  AutomixSDKErrorCodeCannotCreateInputBuffer = 1038,
  AutomixSDKErrorCodeCannotSetupAVAudioSession = 1039,
  AutomixSDKErrorCodeCannotStartAudioEngine = 1040,
  AutomixSDKErrorCodeCannotRestoreAudioSession = 1041,
  AutomixSDKErrorCodeFailedToStop = 1042,
  AutomixSDKErrorCodeCannotLoadExplicitLyricsTrack = 1043,
};
...
enum AutomixSDKPlaylistOperationType : NSInteger;

/// AutomixSDKPlaylistOperation models a move, add or remove operation of a track in a playlist.
SWIFT_CLASS("_TtC14PacemakerRadio27AutomixSDKPlaylistOperation")
@interface AutomixSDKPlaylistOperation : NSObject
/// The type of operation, Add / Remove / Move
@property (nonatomic) enum AutomixSDKPlaylistOperationType type;
...
typedef SWIFT_ENUM(NSInteger, AutomixSDKPlaylistOperationType, open) {
  AutomixSDKPlaylistOperationTypeAdded = 0,
  AutomixSDKPlaylistOperationTypeRemoved = 1,
  AutomixSDKPlaylistOperationTypeMoved = 2,
};
...
@property (nonatomic, copy) NSDictionary<NSString *, NSArray<AutomixSDKPlaylistOperation *> *> * _Nullable playlistDiff;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
typedef SWIFT_ENUM(NSInteger, AutomixSDKStatusVariable, open) {
  ...
  AutomixSDKStatusVariablePlaylistDiff = 32,
};
...
/// AutomixSDKUserCounters models a user’s counters
...
/// AutomixSDKWaveformModel models the waveform of a track.
SWIFT_CLASS("_TtC14PacemakerRadio23AutomixSDKWaveformModel")
@interface AutomixSDKWaveformModel : NSObject
/// The normalised X axis, from 0 (meaning beginning of the track) to 1 (meaning end of the track)
@property (nonatomic, copy) NSArray<NSNumber *> * _Nullable xAxis;
/// The energy of the track over time
...
/// The time in the track the left transition starts at
@property (nonatomic) float leftTransitionStartTime;
/// The time in the track the left transition ends at
@property (nonatomic) float leftTransitionEndTime;
/// The duration of the left transition in track time
@property (nonatomic) float leftTransitionDuration;
/// The time in the track the right transition starts at
@property (nonatomic) float rightTransitionStartTime;
/// The time in the track the right transition ends at
@property (nonatomic) float rightTransitionEndTime;
/// The duration of the right transition in track time
@property (nonatomic) float rightTransitionDuration;
/// The duration of the track in seconds
@property (nonatomic) float trackDurationSeconds;
/// true if this waveform is just placeholder data, false otherwise
@property (nonatomic) BOOL placeholder;
/// The time in this track the next track’s 0 seconds position would be if played, helper to align waveforms when rendering tracnsitions
...
/// \param apiKey The RadioSDK API Key
///
...
///
///
- (void)initialiseWithApiKey:(NSString * _Nonnull)apiKey streamingDelegate:(id <AutomixSDKStreamingDelegate> _Nonnull)streamingDelegate statusDelegate:(id <AutomixSDKStatusObserverDelegate> _Nonnull)statusDelegate radioUIDelegate:(id <RadioUIDelegate> _Nonnull)radioUIDelegate interfaceWidth:(float)interfaceWidth interfaceHeight:(float)interfaceHeight countryCode:(NSString * _Nonnull)countryCode storeId:(NSString * _Nonnull)storeId applicationId:(NSString * _Nonnull)applicationId completion:(void (^ _Nullable)(NSError * _Nullable))completion;
/// Returns the singleton instance.
///
/// returns:
/// The singleton instance.
...
/// Called by AutomixSDK when the Radio UI about to be dismissed
- (void)willDismissRadioUI;
/// Called by AutomixSDK when the Radio UI is closed
- (void)didCloseRadioUI;
/// Called by AutomixSDK when the Radio UI is closed
- (void)willCloseRadioUI;
@end
