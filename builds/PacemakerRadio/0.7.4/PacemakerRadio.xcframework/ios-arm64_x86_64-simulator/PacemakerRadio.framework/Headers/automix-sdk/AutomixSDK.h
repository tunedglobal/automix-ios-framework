...
-(nullable NSArray<NSArray<NSNumber*>*>*)waveformDataForTrackWithIdentifier:(nonnull NSString*)identifier applyEnterTransition:(BOOL)applyEnterTransition applyExitTransition:(BOOL)applyExitTransition;
-(nullable NSArray<NSArray<NSNumber*>*>*)placeholderWaveformDataForTrackWithIdentifier:(nonnull NSString*)identifier;
