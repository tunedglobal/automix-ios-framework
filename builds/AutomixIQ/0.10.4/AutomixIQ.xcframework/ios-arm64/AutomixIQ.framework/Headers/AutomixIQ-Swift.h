...
/// \param apiKey The AutomixIQ API Key
///
...
///
/// \param statusDelegate The delegate in charge of updating any UI with status updates from AutomixIQ. See AutomixSDKStatusObserverDelegate.
///
/// \param countryCode The ISO2 country code the device is located in..
///
/// \param storeId Tuned Global’s store ID.
///
/// \param applicationId Tuned Global’s Application ID.
///
...
/// \param apiKey The AutomixIQ API Key
///
/// \param streamingDelegate The delegate in charge of feeding all data and metadata the AutomixIQ needs. See AutomixSDKStreamingDelegate.
///
/// \param statusDelegate The delegate in charge of updating any UI with status updates from AutomixIQ. See AutomixSDKStatusObserverDelegate.
///
/// \param countryCode The ISO2 country code the device is located in.
...
SWIFT_CLASS("_TtC9AutomixIQ27AutomixSDKPlaylistOperation")
...
typedef SWIFT_ENUM(NSInteger, AutomixSDKStatusVariable, open) {
  ...
  AutomixSDKStatusVariablePlaylistDiff = 31,
};
...
SWIFT_CLASS("_TtC9AutomixIQ23AutomixSDKWaveformModel")
