...
///
///
+ (void)initialiseWithConfig:(AutomixSDKConfig * _Nonnull)config tunedDelegate:(id <TunedRestDelegate> _Nonnull)tunedDelegate statusDelegate:(id <AutomixSDKStatusObserverDelegate> _Nullable)statusDelegate musicCacheDelegate:(id <TunedMusicCacheDelegate> _Nullable)musicCacheDelegate completion:(void (^ _Nullable)(NSError * _Nullable))completion;
...
///
///
+ (void)initialiseWithConfig:(AutomixSDKConfig * _Nonnull)config streamingDelegate:(id <AutomixSDKStreamingDelegate> _Nonnull)streamingDelegate statusDelegate:(id <AutomixSDKStatusObserverDelegate> _Nullable)statusDelegate completion:(void (^ _Nullable)(NSError * _Nullable))completion;
...
SWIFT_CLASS("_TtC9AutomixIQ16AutomixSDKConfig")
