...
@protocol AutomixSDKCachedMusicProvider;
@class AutomixSDKTrackModel;
@class AutomixSDKStatus;
#ifdef RADIO_PODSPEC
@class TunedAuthenticationResponse;
#endif
...
+(void)initialiseWithTunedDelegate:(nonnull id<TunedRestDelegate>)tunedDelegate
               ...
               cachedMusicProvider:(nullable id<AutomixSDKCachedMusicProvider>)cachedMusicProvider
...
-(void)setCachedMusicProvider:(nullable id<AutomixSDKCachedMusicProvider>)musicCacheDelegate;
...
-(void)resetMixToEmptyWithCompletion:(nullable CompletionWithError)completion;
...
-(void)setAutomixTempoNormalised:(float)tempoNormalised completion:(nullable CompletionWithError)completion;
...
#ifdef RADIO_PODSPEC
-(nullable TunedAuthenticationResponse*)tunedCredentials;
#endif
