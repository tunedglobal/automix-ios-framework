Pod::Spec.new do |s|
  ...
  s.license          = { :type => 'MIT', :file => 'builds/PacemakerRadio/0.6.1/PacemakerRadio-LICENSE' }
  ...
  s.vendored_frameworks = "builds/PacemakerRadio/0.6.1/PacemakerRadio.xcframework"
  s.platform = :ios
  s.swift_version    = '5.5'
